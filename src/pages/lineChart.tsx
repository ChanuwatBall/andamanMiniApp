...
export default class lineChart extends React.Component{
	...
	state= {
        ...
        reportTitle: "รายงานกราฟเส้นน้ำมัน",
        close : "ปิด",
		loading: "กำลังโหลด...",
		List: [{
			device_id : 0,
	...
	render(){
		...
		{/* <IonRow style={{padding:'0px',marginTop:'.5rem'}}>
		  <IonCol size="12" style={{padding:'0px'}}>
			<IonLabel style={{margin:"10px"}}>วันสิ้นสุด</IonLabel><br/>
		  		<div className="dateBox">
                    <div style={{float:"left"}} className="dateLabel">
                        <IonLabel color='medium'><h6> วันสิ้นสุด </h6></IonLabel>
                    </div>
                        <div style={{float:'right',color:'#666666'}} className="dateItem">
						<IonDatetime 
							onIonChange={(e:any)=>{this.dateSelect(e); }}
